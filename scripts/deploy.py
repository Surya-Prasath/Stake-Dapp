...
def deploy_token_farm_and_dapp_token(front_end_update=False):
    ...
    token_farm = TokenFarm.deploy(dapp_token, {"from": account}, publish_source=config["networks"][network.show_active()].get("verify", False))
...
def update_front_end():
    ...
    # Sending the front-end our config-yaml in JSON format as typescript can't handle yaml
